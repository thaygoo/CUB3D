...
It implements a ray‑casting renderer, player movement, collision detection, textured walls, and real‑time 3D projection using MiniLibX.
...
When a wall is hit, the perpendicular distance is computed and corrected to avoid fisheye distortion.
3. Projection

Wall height is computed using:
line_height=HEIGHTperpendicular_distance
